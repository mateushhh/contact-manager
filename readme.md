...
Project developed in .NET Core with REST API.
...
SQL Queries were tested on [db-fiddle.com](https://www.db-fiddle.com/f/mRQHJcPWqVfvRA3VKnasvD/13) website with MySQL v9 database, by clicking the link you should be transferred to a premade example with this project schema and select queries.